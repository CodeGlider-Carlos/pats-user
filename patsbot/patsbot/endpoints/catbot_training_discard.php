...
/*
=========================================================
ez/patsbot/endpoints/catbot_training_discard.php
Descartar entrenamiento CAT BOT PATS
=========================================================
*/
...
$comentario = trim((string)($input['comentario'] ?? 'Descartado desde panel de entrenamiento.'));
...
try {
  ...
  train_json([
    'ok' => true,
    'message' => 'Pregunta descartada.',
    'queue_id' => $queueId
  ]);

} catch (Throwable $e) {
  train_fail('No fue posible descartar el registro.', 500);
}