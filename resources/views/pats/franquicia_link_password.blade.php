{{-- resources/views/pats/franquicia_link_password.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Acceso al formulario · PATS Franquicia</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo__name  { font-size: 20px; font-weight: 800; color: var(--navy); letter-spacing: -.02em; }
        ...
        .card__head-title { font-size: 18px; font-weight: 800; color: #fff; margin-bottom: 6px; }
        .card__head-sub   { font-size: 13px; color: rgba(255,255,255,.7); line-height: 1.5; }

        .card__body { padding: 32px; }

        .info-badge {
            display: flex; align-items: center; gap: 10px;
            background: #ecfdf5; border: 1.5px solid rgba(16,185,129,.2);
            border-radius: 12px; padding: 14px 18px; margin-bottom: 24px;
        }
        .info-badge__icon { font-size: 22px; color: #10b981; }
        .info-badge__label { font-size: 12px; color: #047857; font-weight: 600; text-transform: uppercase; letter-spacing: .06em; }
        .info-badge__value { font-size: 15px; font-weight: 700; color: #065f46; line-height: 1; }
        ...
        .input {
            ...
            background: #f8faff; transition: border-color .15s, box-shadow .15s; outline: none;
        }
        ...
        .error-box {
            ...
            font-size: 13px; color: #b91c1c; font-weight: 600; margin-bottom: 18px;
        }
...
<div class="wrap">
    ...
    <div class="logo">
        <div class="logo__icon"><i class="mdi mdi-store-outline"></i></div>
        <div>
            <div class="logo__name">PATS</div>
            <div class="logo__sub">Red de Franquicias</div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card__body">
            ...
            <div class="info-badge">
                <i class="mdi mdi-check-circle-outline info-badge__icon"></i>
                <div>
                    <div class="info-badge__label">Proceso de alta</div>
                    <div class="info-badge__value">Solicitud de Franquicia</div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('franq.link.auth', $token) }}">
                @csrf
                <div class="field">
    ...
    <div class="footer">
        PATS · Red de Franquicias Médicas<br>
