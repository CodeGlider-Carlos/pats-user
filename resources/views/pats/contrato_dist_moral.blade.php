...
<head>
    ...
    <title>Contrato de Distribución (Persona Moral) — Pasaporte a tu Salud</title>
    <link
...
<body>
        ...
        <div class="cover-inner">
            ...
            <div class="cover-parties">
                ...
                <div class="cover-party">
                    ...
                    <p>Persona moral señalada<br />en el Apartado 5 de la Carátula,<br />representada por el Apartado 7</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page">
        <div class="caratula-section" id="caratula">
            ...
            <table class="caratula-table">
                ...
                <tr>
                    ...
                    <td>Calle Rio Jamapa Número 6141, Col. Jardines de San Manuel, Ciudad de Puebla, Estado de Puebla,
                        C.P. 72,570</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Apartado 5 — Nombre del Distribuidor (Razón Social)</td>
                    <td><span class="badge" id="c_nombre">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 6 — Escritura Constitutiva del Distribuidor</td>
                    <td>
                        <table style="width:100%;font-size:13px;border-collapse:collapse;">
                            <tr><td style="padding:3px 0;color:#7a7a7a;width:55%;">Número de Instrumento:</td><td><span class="badge" id="c_escritura_num">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Número de Volumen:</td><td><span class="badge" id="c_escritura_vol">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Fecha:</td><td><span class="badge" id="c_escritura_fecha">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Notaría / Correduría:</td><td><span class="badge" id="c_notaria">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Distrito Judicial:</td><td><span class="badge" id="c_distrito_jud">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Estado:</td><td><span class="badge" id="c_estado_escritura">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">R.P.C.:</td><td><span class="badge" id="c_rpc">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Folio Mercantil:</td><td><span class="badge" id="c_folio">Por llenar</span></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td>Apartado 7 — Nombre del Representante Legal del Distribuidor</td>
                    <td><span class="badge" id="c_rep_nombre">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 8 — Nombramiento del Representante Legal</td>
                    <td><span class="badge" id="c_rep_nombramiento">Representante Legal</span></td>
                </tr>
                <tr>
                    <td>Apartado 9 — Escritura con la que acredita personalidad el Representante Legal</td>
                    <td>
                        <table style="width:100%;font-size:13px;border-collapse:collapse;">
                            <tr><td style="padding:3px 0;color:#7a7a7a;width:55%;">Número de Instrumento:</td><td><span class="badge" id="c_rep_escritura_num">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Número de Volumen:</td><td><span class="badge" id="c_rep_escritura_vol">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Fecha:</td><td><span class="badge" id="c_rep_escritura_fecha">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Notaría / Correduría:</td><td><span class="badge" id="c_rep_notaria">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Distrito Judicial:</td><td><span class="badge" id="c_rep_distrito_jud">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Estado:</td><td><span class="badge" id="c_rep_estado_escritura">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">R.P.C.:</td><td><span class="badge" id="c_rep_rpc">Por llenar</span></td></tr>
                            <tr><td style="padding:3px 0;color:#7a7a7a;">Folio Mercantil:</td><td><span class="badge" id="c_rep_folio">Por llenar</span></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td>Apartado 10 — R.F.C. del Distribuidor</td>
                    <td><span class="badge" id="c_rfc">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 11 — Domicilio Fiscal del Distribuidor</td>
                    <td><span class="badge" id="c_domicilio">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 12 — Nombre del Franquiciatario</td>
                    <td><span class="badge" id="c_franquicia">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 13 — Demarcación Territorial</td>
                    <td><span class="badge" id="c_demarcacion">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 14 — Precio del Derecho de Distribución</td>
                    <td><strong>$20,000.00 M.N.</strong> (Veinte mil pesos, IVA incluido)</td>
                </tr>
                <tr>
                    <td>Apartado 15 — Cuenta Bancaria del Proveedor</td>
                    <td>CLABE: 042650016008666521<br />Banca Mifel, S.A., Institución de Banca Múltiple, Grupo
                        Financiero Mifel</td>
                </tr>
                <tr>
                    <td>Apartado 16 — Fecha de Inicio de Vigencia</td>
                    <td><span class="badge" id="c_fecha_inicio">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 17 — Fecha de Fin de Vigencia</td>
                    <td><span class="badge" id="c_fecha_fin">Por llenar</span></td>
                </tr>
                <tr>
                    <td>Apartado 18 — Anexos</td>
                    <td>Anexos 1 al 13 (ver índice de anexos)</td>
                </tr>
                <tr>
                    <td>Apartado 19 — Fecha de Firma</td>
        ...
        <div class="clause">
            ...
            <div class="clause-body">
                <p>A. Su representada es una sociedad mercantil constituida conforme a las leyes mexicanas, según consta
                    en la escritura pública descrita en el Apartado 6 de la Carátula (Anexo 3).</p>
                <p>B. La persona física que la representa, señalada en el Apartado 7 de la Carátula, cuenta con todas
                    las facultades necesarias para la celebración del presente contrato, según consta en el instrumento
                    descrito en el Apartado 9 de la Carátula (Anexo 4). Su nombramiento se señala en el Apartado 8.</p>
                <p>C. Su representada se encuentra inscrita en el R.F.C. señalado en el Apartado 10 de la Carátula y
                    tiene como domicilio fiscal el señalado en el Apartado 11 (Anexo 5). Los recursos provienen de
                    fuentes lícitas.</p>
                ...
                <p>F. Recibe en este acto el Manual de Afiliado (Anexo 7), que deberá ser entregado a cada adquirente de
                    la Tarjeta.</p>
                <p>G. Ha sido informado sobre los criterios financieros para determinar sus márgenes de utilidad, y
                    recibe el Manual de Operación del Sistema PATS (Anexo 8).</p>
            </div>
        </div>
        ...
        <div class="sig-block">
            ...
            <div class="sig-party">
                ...
                <div class="sig-role">La persona moral señalada en el Apartado 5,<br />representada por la persona física señalada en el Apartado 7</div>
            </div>
        </div>
