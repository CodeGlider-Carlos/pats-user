...
<head>
    ...
    <title>Recuperar contraseña | PATS</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .alert-success { background: #edfaf5; color: #1a7a52; border: 1px solid #a3e4c8; }
...
<div class="auth-shell">
    ...
    <div class="form-panel">
        ...
        <p class="form-kicker">Recuperación de cuenta</p>
        <h2 class="form-title">¿Olvidaste tu contraseña?</h2>
        <p class="form-hint">Ingresa tu correo registrado y te enviaremos un enlace para crear una nueva contraseña.</p>
