...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600&family=Outfit:wght@300;400;500;600&display=swap"
        rel="stylesheet">
    ...
    <div class="auth-shell">
        ...
        <div class="brand">
            ...
            <div class="brand-logo" style="display:flex; align-items:center;">
                <img src="{{ asset('images/logo_50.png') }}" alt=""
                    style="filter: brightness(0) invert(1); height:36px;">
                <span style="color:#fff; font-weight:300; margin:0 8px; opacity:.6; font-size:1.4rem;">|</span>
                <img src="{{ asset('images/PATS_LOGO.png') }}" alt="PATS"
                    style="filter: brightness(0) invert(1); height:36px;">
            </div>
                ...
                <div class="field">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="pass-toggle" onclick="togglePass()"
                            aria-label="Mostrar contraseña" id="passBtn">
